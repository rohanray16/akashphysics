        ...
        <>
            ...
            <div className='heading6 pt-5 pb-5 container-fluid' id='demo-video'>
                ...
                <div className="row d-flex justify-content-between mt-4 align-items-center">
                    ...
                    <div className='col-xs-12 col-sm-6 col-lg-4 d-flex justify-content-center mt-3'>
                        <iframe className='frame-border' width="200" height="113" src="https://www.youtube.com/embed/v0I1vs5gGMU" title="Class 12th | Gauss Law| Part 1 | Electrostatics" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div className='col-xs-12 col-sm-6 col-lg-4 d-flex justify-content-center mt-3'>
                        <iframe className='frame-border' width="200" height="113" src="https://www.youtube.com/embed/iArGXw_cHGE" title="Class 11th | HCV Discussion | Rotation OBJECTIVES" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div className='col-xs-12 col-sm-6 col-lg-4 d-flex justify-content-center mt-3'>
                        <iframe className='frame-border' width="200" height="113" src="https://www.youtube.com/embed/fZxeLKu_fU4" title="Class 11th | Work Energy theorem | Class Problems" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                {/* <div className="d-flex justify-content-center mt-5 mb-3">
                    <button className='btn btn-outline-dark'>View more videos</button>
                </div> */}
                <div className='h2 mt-5 text-center'>Check out above videos</div>
